...
const double tau = 0.075; // MAGIC !!
double compAngleX, compAngleY; // Calculated angle using a complementary filter
double a; // parameter for the filter
...
// HERE IS THE FILTER: FIRST-ORDER COMPLEMENTARY FILTER
  // Calculate the parameter for the Complementary filter
  a = tau / (tau + dt);
  // Calculate the angle using a Complementary filter
  compAngleX = a * (compAngleX + gyroXrate * dt) + (1-a) * roll;
  compAngleY = a * (compAngleY + gyroYrate * dt) + (1-a) * pitch;
  // END OF FILTER
